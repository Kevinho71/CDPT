...
public interface InstitucionRepository extends GenericRepositoryNormal<InstitucionEntity, Integer> {
  ...
  List<InstitucionEntity> findAll(String paramString, int paramInt);
  ...
  Page<InstitucionEntity> findAll(@Param("estado") int paramInt, @Param("search") String paramString, @Param("pageable") Pageable paramPageable);
...
/* Location:              C:\Users\Usuario\Desktop\CADET.jar!\BOOT-INF\classes\app\repository\InstitucionRepository.class
